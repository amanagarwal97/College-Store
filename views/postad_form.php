...
<form action="postad.php" method="post" enctype="multipart/form-data" class="postad-form">
    ...
    <select name="category" required>
        ...
        <input type="radio" name="choice" value="0" class="sell" required><span>Donate</span>
        <input type="radio" name="choice" value="1" class="sell"><span>Sell</span><br>
        <input type="text" name="price" placeholder="Your Price (In Rs.)" required>
        <input type="hidden" name="MAX_FILE_SIZE" value="30000000">
        <label for="upload-img" class="btn">Upload Image :</label>
        <input class="upload-img" type="file" name="image" required>
